...
class SyncMDCandle(SyncCandle):
    def __init__(self):
        SyncCandle.__init__(self)
        self.sDir = os.path.abspath(os.path.join(os.path.abspath('..'), 'data', 'rest_http', 'kline'))
        self.payload = {}
    ...
    #     print('sync')
    #     SyncCandle.sync_kline(*args)

    #     sdataDir = os.path.join(sMDDir, stime, SOLUTION)
    #     # print(sdataDir)
